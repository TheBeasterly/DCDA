...
# Assuming your PyInstaller executable is named 'OPPCAnalyzer.app' and is
# located in a 'dist' folder relative to the bash script. Adjust if necessary.
EXECUTABLE_PATH="../../../dist/OPPCAnalyzer.app" 

# Execute the PyInstaller-generated executable
